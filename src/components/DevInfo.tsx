        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col md:flex-row justify-around items-center">
            ...
            <div className="mb-8 md:mb-0 md:w-1/3">
              ...
              <p className="text-gray-600">Diploma in Computer Technology, Pabna Polytechnic Institute</p>
              <p className="text-gray-600">B.S. in Computer Science, Northern University Bangladesh</p>
            </div>
            <div className="md:w-1/3">
              ...
              <p className="text-gray-600">JavaScript, React, Next js, Node.js, Python, Django, Tailwind CSS</p>
            </div>
          </div>
        </div>
      </div>
